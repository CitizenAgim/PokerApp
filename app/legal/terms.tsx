...
export default function TermsOfServiceScreen() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: themeColors.background }]} contentContainerStyle={styles.content}>
      ...
      <Text style={[styles.heading, { color: themeColors.heading }]}>1. Acceptance of Terms</Text>
      <Text style={[styles.paragraph, { color: themeColors.subText }]}>
      ...
      <Text style={[styles.heading, { color: themeColors.heading }]}>2. Description of Service</Text>
      <Text style={[styles.paragraph, { color: themeColors.subText }]}>
      ...
      <Text style={[styles.heading, { color: themeColors.heading }]}>3. User Accounts</Text>
      <Text style={[styles.paragraph, { color: themeColors.subText }]}>
